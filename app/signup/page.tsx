      ...
      <div className="min-h-screen flex items-center justify-center px-4 py-20">
        ...
        >
          ...
          <p className="text-thera-muted mb-6">
            We&apos;ve sent a verification link to <span className="text-thera-text">{email}</span>. Click the link to verify your account and get started.
          </p>
          <Link
            href="/login"
      ...
      >
        ...
        <div className="p-8 rounded-3xl bg-thera-ink/5 border border-thera-ink/10 backdrop-blur-sm">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-start gap-2 cursor-pointer">
              <input
                ...
                className="mt-0.5 w-4 h-4 rounded border-thera-ink/20 bg-thera-ink/5 text-thera-primary focus:ring-thera-primary/20"
                required
              />
          ...
          <div className="flex items-center gap-4 my-6">
            <div className="flex-1 h-px bg-thera-ink/10" />
