...
const faqs = [
  {
    ...
    answer: "Browsing the directory is free for clients. Therapists pay KES 950/month to be listed — no commission on sessions, no other fees.",
  },
  {
    question: "Do you handle bookings or session payments?",
    answer: "No. TheraSpace is a directory — you contact a therapist directly by phone or email and arrange sessions and payment between yourselves. The KES 950/month only covers the therapist's listing.",
  },
  {
